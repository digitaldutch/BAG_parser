...
## Download BAG SQLite
The latest generated BAG in SQLite format can be downloaded, in 7-Zip format, from our [releases section](https://github.com/digitaldutch/BAG_parser/releases).
