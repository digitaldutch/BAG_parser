...
## TL;DR
Converts in 10 minutes the big, complex and hard to read XML Dutch addresses database (BAG or Basisregistratie Adressen
...
* Run `import_bag.py`
* Drink a cup of coffee for 10 minutes ☕😎 while watching the progress bar.
