...
beautiful user-friendly SQLite database. 
...
The bad news is: it comes in a complex and hard to read XML format using thousands of zipped XML files, which will quickly 
